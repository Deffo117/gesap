...
import { LoginPageComponent } from "C:/Users/ulric/gesap/src/app/pages/content-pages/login/login-page.component";
import { AddContbailComponent } from 'C:/Users/ulric/gesap/src/app/cont_bail/add-contbail/add-contbail.component';
...
export const Full_ROUTES: Routes = [
  ...
  {path: 'taskboard-ngrx',loadChildren: () => import('../../taskboard-ngrx/taskboard-ngrx.module').then(m => m.TaskboardNGRXModule)},
  {path: 'player',loadChildren: () => import('../../player/player.module').then(m => m.PlayerModule)},
  {path: 'addcontbail', component: AddContbailComponent, data: { title: 'AddContBail'}},
